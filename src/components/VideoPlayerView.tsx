            ...
            <div className="hidden print:block print-container text-black bg-white min-h-screen">
                ...
                <div className="mt-12 pt-8 border-t border-slate-200 text-center">
                    <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">
                        Generated by Watch1Do1 Vision Logic Engine. Visit watch1do1.com for more project kits.
                    </p>
                </div>
            </div>
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center gap-6">
                                        ...
                                        <div className="text-center">
                                            <p className="text-xl font-black tracking-tighter uppercase">Project Insights Active</p>
                                        ...
                                        {isDeepDiving && (
                                            <div className="w-full mt-6 p-8 bg-slate-900/50 border-2 border-dashed border-[#7D8FED]/30 rounded-[2rem] flex flex-col items-center gap-4 animate-pulse">
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-1">Identifying specialized professional gear</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                            ...
                            {insights && (
                                <div className="mt-auto p-6 bg-slate-950/50 border-t border-slate-800">
                                    ...
                                    <p className="text-[8px] font-bold text-slate-600 uppercase tracking-widest leading-relaxed">
                                        * Estimates based on current market data and visual logic analysis. Actual costs may vary by region.
                                    </p>
                                </div>
                            )}
                        </div>
